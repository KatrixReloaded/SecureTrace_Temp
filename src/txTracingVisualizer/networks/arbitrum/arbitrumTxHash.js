...
const provider = new ethers.JsonRpcProvider(`https://arb-mainnet.g.alchemy.com/v2/${settings.apiKey}`); // Same API key for provider

const transactionHash = '0x025cf2858723369d606ee3abbc4ec01eab064a97cc9ec578bf91c6908679be75';
...
async function fetchTokenTransfersFromTx(txHash) {
    try {
        ...
        console.log('ERC-20 Token Transfers:', decodedTransfers);
...
fetchTokenTransfersFromTx(transactionHash).then(transfers => {
    console.log('All Token Transfers from Arbitrum Transaction:', transfers);
});
